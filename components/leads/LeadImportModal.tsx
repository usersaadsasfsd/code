    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          console.error(
            "Import: Failed to parse error response",
            jsonParseError,
          )
          errorData = {
...
const downloadTemplate = () => {
  ...
  const exampleRow = "John Doe,john@example.com,9876543210,15-01-2024,Residential,50L-1Cr,Mumbai,Website,New,Medium,Lead,Good prospect\n"
