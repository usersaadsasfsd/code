      ...
      return selectedFieldKeys.map((key) => {
        ...
        switch (key) {
          ...
          case "notes":
            ...
            break
          case "createdAt":
            value = formatToDDMMYYYY(lead.createdAt)
            break
          case "receivedDate":
            value = lead.receivedDate ? formatToDDMMYYYY(lead.receivedDate) : "N/A"
            break
          case "assignedDate":
            value = lead.assignedDate ? formatToDDMMYYYY(lead.assignedDate) : "Not Assigned"
            break
          case "lastContacted":
            value = lead.lastContacted ? formatToDDMMYYYY(lead.lastContacted) : "Never"
            break
          case "lastComment": {
            const last =
          ...
          case "lastCommentDate": {
            const last =
              lead.activities && lead.activities.length > 0 ? lead.activities[lead.activities.length - 1] : null
            value = last ? formatToDDMMYYYY(last.date) : ""
            break
          }
